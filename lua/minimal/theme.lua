...
M.plugins = {
    ...
    TelescopePromptBorder = { fg = colors.gray1, bg = colors.gray1 },
    TelescopePromptNormal = { fg = colors.white1, bg = colors.gray1 },
    TelescopeNormal = { fg = colors.white1, bg = colors.black1 },
    TelescopePreviewTitle = { fg = colors.gray1, bg = colors.orange_wr },
    TelescopePreviewLine = { bg = colors.gray1 },
    TelescopePreviewSelected = { fg = colors.black1, bg = colors.orange_wr },
    TelescopePromptTitle = { fg = colors.black1, bg = colors.red_key_w },
    TelescopeResultsTitle = { fg = colors.black1, bg = colors.black1 },
    TelescopeResultsDiffAdd = { fg = colors.red_key_w, bg = "#333333" },
    TelescopeResultsDiffChange = { fg = colors.red_key_w, bg = "#333333" },
